...
**Tests**: The examples below include test tasks. Tests are mandatory for any
change touching parsing, schema validation, graph model, layout, or
render-preparation logic. UI tests do not replace these isolated tests.
...
- [ ] T010 [P] Define JSON node/edge schema and validation error contract
- [ ] T011 [P] Create isolated graph parsing/model/layout/render-preparation module boundaries
- [ ] T012 [P] Add 5,000-node performance fixture or benchmark harness
...
> **NOTE: Write tests FIRST and ensure they FAIL before implementation. Include
> isolated tests whenever this story changes parsing, validation, graph model,
> layout, or render-preparation logic.**
...
- [ ] T015 [P] [US1] Isolated test for [parsing/validation/layout/render-preparation] in tests/unit/test_[name].[ext]
...
- [ ] T022 [US1] Verify schema errors are reported to the user before render
...
- [ ] TXXX Run 5,000-node pan/zoom performance validation
...
- Isolated tests for parsing, validation, graph model, layout, or
  render-preparation changes MUST be written and FAIL before implementation
